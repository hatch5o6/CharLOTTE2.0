...
#SBATCH --job-name=test_BLI.an.sh
#SBATCH --qos matrix
...
TARGET_FILE_PATH=/home/hatch5o6/nobackup/archive/data/MONOLINGUAL/Aragonese/Comprised/an.7k.txt
hf_model_name=dccuchile/bert-base-spanish-wwm-cased
OUTDIR=/home/hatch5o6/nobackup/archive/CharLOTTE2.0/test_bli_an
threshold=0.5
iterations=3
batch_size=100
lang=an
